...
def information_gain(previous_y, current_y):
    ...
    left = entropy(current_y[0]) * len(current_y[0])/len(previous_y)
    right = entropy(current_y[1]) * len(current_y[1])/len(previous_y)
    info_gain = pre_entropy - (left + right)
